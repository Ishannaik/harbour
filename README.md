...
- **Ten sources, one query** — searches FitGirl, YTS, TPB, 1337x, EZTV, Nyaa,
  SubsPlease, and BitTorrented simultaneously, grouped into Games, Movies, TV,
...
| ID | Label | Groups |
| --- | --- | --- |
| `fitgirl` | FitGirl | Games |
| `yts` | YTS | Movies |
| `tpb-movies` | TPB | Movies |
| `x1337-movies` | 1337x | Movies |
| `eztv` | EZTV | TV |
| `tpb-tv` | TPB | TV |
| `x1337-tv` | 1337x | TV |
| `nyaa` | Nyaa | Anime |
| `subsplease` | SubsPlease | Anime |
| `bittorrented` | BitTorrented | Movies |

Games is the only category that runs code, so it stays with FitGirl — a

...
- **Sources track — the ReelIndex critical path.** The reference product fetches up to
  four detail pages per ReelIndex search purely to extract magnets, and registers ReelIndex
...
4. **Dhruv** — the lazy-ReelIndex suggestion in §5. Yours to take or leave; it is the

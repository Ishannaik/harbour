...
- **Dhruv (newbie)** takes the sources on-ramp: RSS first (EZTV, Nyaa) → JSON (YTS, TPB) → HTML (1337x, FitGirl, BitTorrented). Each scraper is a complete, testable deliverable on its own.

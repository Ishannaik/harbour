...
fn result_line(
    ...
    } else if result.source == SourceId::GamesHub || result.source == SourceId::FanSubs {
        "50+".into()
    } else if result.source == SourceId::ShowPort {
        "10+".into()
    } else {
        "—".into()
    };
    ...
    } else if result.source == SourceId::GamesHub
        || result.source == SourceId::FanSubs
        || result.source == SourceId::ShowPort
    {
        colors.success()
    } else {
        colors.dim()

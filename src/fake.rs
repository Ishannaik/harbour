...
const SOURCES: &[(&str, &str, &str, u64, u64)] = &[
    ("gameshub", "GamesHub", "(2026) [Repack] [Multi]", 20 << 30, 60 << 30),
    ("cinevault", "CineVault", "(2026) [1080p] [WEBRip]", 1 << 30, 4 << 30),
    ("vault-movies", "VaultIndex", "(2026) [1080p] [BluRay]", 734_003_200, 4 << 30),
    ("reel-movies", "ReelIndex", "(2026) [1080p] [BluRay]", 2 << 30, 8 << 30),
    ("showport", "ShowPort", "S01E01 [1080p] [WEBRip]", 734_003_200, 3 << 30),
    ("vault-tv", "VaultIndex", "S01E01 [1080p] [H.264]", 734_003_200, 3 << 30),
    ("tsukibase", "TsukiBase", "- 01 [1080p] [HEVC] [AAC]", 734_003_200, 2 << 30),
    ("fansubs", "FanSubs", "- 01 [1080p] [HEVC]", 734_003_200, (3 << 30) / 2),
    ("torrent-hub", "TorrentHub", "(2026) [1080p] [BluRay]", 1 << 30, 6 << 30),
];

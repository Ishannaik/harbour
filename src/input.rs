...
mod tests {
    ...
    fn a_click_on_a_sidebar_source_toggles_it() {
        ...
        // title, Games divider, GamesHub, Movies divider, CineVault, VaultIndex, ReelIndex,
        // TorrentHub, TV divider, ShowPort, VaultIndex-TV, ReelIndex-TV, Anime divider,
        // TsukiBase, FanSubs.
        let cases = [
            (1, None),
            (2, None),
            (3, Some(SourceId::GamesHub)),
            (4, None),
            (5, Some(SourceId::CineVault)),
            (6, Some(SourceId::VaultMovies)),
            (7, Some(SourceId::ReelSource)),
            (8, Some(SourceId::TorrentHub)),
            (9, None),
            (10, Some(SourceId::ShowPort)),
            (11, Some(SourceId::VaultTv)),
            (12, Some(SourceId::ReelTv)),
            (13, None),
            (14, Some(SourceId::TsukiBase)),
            (15, Some(SourceId::FanSubs)),
            (16, None),
            (29, None),
        ];
        ...
        assert_eq!(
            ...
            Action::ToggleSource(SourceId::CineVault)
        );

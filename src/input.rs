...
mod tests {
    ...
    fn a_click_on_a_sidebar_source_toggles_it() {
        ...
        // title, Games, GamesHub, Movies, CineVault, VaultIndex, TorrentHub,
        // TV, ShowPort, VaultIndex-TV, FeedLine, Anime, TsukiBase, FanSubs, AnimeMirror.
        let cases = [
            (1, None),
            (2, None),
            ...
            (7, Some(SourceId::TorrentHub)),
            (8, None),
            (9, Some(SourceId::ShowPort)),
            (10, Some(SourceId::VaultTv)),
            (11, Some(SourceId::FeedLine)),
            (12, None),
            (13, Some(SourceId::TsukiBase)),
            (14, Some(SourceId::FanSubs)),
            (15, Some(SourceId::AnimeMirror)),
            (16, None),
            (29, None),
        ];
